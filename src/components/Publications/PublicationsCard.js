...
import eduImgWhite from '../../assets/png/publications/ieee_logo.png'
import eduImgBlack from '../../assets/png/publications/ieee_logo.png'
import './Publications.css'

function PublicationsCard({ id, institution, course, startYear, endYear }) {
